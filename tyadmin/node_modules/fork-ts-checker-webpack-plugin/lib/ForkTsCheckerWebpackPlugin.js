...
const tapDoneToCollectRemoved_1 = require("./hooks/tapDoneToCollectRemoved");
...
class ForkTsCheckerWebpackPlugin {
    constructor(options = {}) {
        ...
        schema_utils_1.default(ForkTsCheckerWebpackPluginOptions_json_1.default, options, 'ForkTsCheckerWebpackPlugin');
        this.options = deepmerge_1.default(externalOptions || {}, options || {});
        // then validate merged options
        schema_utils_1.default(ForkTsCheckerWebpackPluginOptions_json_1.default, this.options, 'ForkTsCheckerWebpackPlugin');
    }
    ...
    apply(compiler) {
        ...
        if (reporters.length) {
            ...
            tapDoneToCollectRemoved_1.tapDoneToCollectRemoved(compiler, configuration, state);
            tapAfterCompileToAddDependencies_1.tapAfterCompileToAddDependencies(compiler, configuration);
...
ForkTsCheckerWebpackPlugin.version = '5.0.7'; // will be replaced by the @semantic-release/exec
