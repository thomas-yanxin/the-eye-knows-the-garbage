...
function createIssuesFromTsDiagnostics(diagnostics) {
    return issue_1.deduplicateAndSortIssues(diagnostics.map((diagnostic) => createIssueFromTsDiagnostic(diagnostic)));
}
