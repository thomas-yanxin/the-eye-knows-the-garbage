...
var proFormItemRender = function proFormItemRender(_ref2) {
  ...
  var valueType = item.valueType,
      ...
      rest = _objectWithoutProperties(item, ["valueType", "dataIndex", "valueEnum", "renderFormItem", "render", "hideInForm", "hideInSearch", "hideInTable", "renderText", "order", "initialValue", "ellipsis", "formItemProps", "index", "customCol"]);
  ...
  if (item.customCol !== undefined) {
    return _react.default.createElement(_col.default, Object.assign({}, customCol, {
      key: key
...
var FormSearch = function FormSearch(_ref3) {
  ...
  return _react.default.createElement(_configProvider.ConfigConsumer, null, function (_ref5) {
    ...
    var meColConfig = isForm ? defaultFormColConfig : defaultColConfig;
    var meOffset = isForm ? 0 : getOffset(domList.length, colSize);
    return _react.default.createElement("div", {
      ...
      shouldUpdate: true,
      noStyle: true
    }, _react.default.createElement(_react.default.Fragment, null, domList)), _react.default.createElement(_col.default, Object.assign({}, meColConfig, {
      offset: meOffset,
      key: "option",
