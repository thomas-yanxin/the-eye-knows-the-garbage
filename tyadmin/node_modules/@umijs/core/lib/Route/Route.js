...
class Route {
  ...
  getRoutes(opts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this.patchRoutes(routes, _objectSpread({}, opts, {
        isConventional
      }));
      return routes;
    })();
  ...
  patchRoute(route, opts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (route.routes) {
        yield _this3.patchRoutes(route.routes, _objectSpread({}, opts, {
          parentRoute: route
        }));
      } else {
        if (!('exact' in route)) {
      ...
      if (route.component && !opts.isConventional && typeof route.component === 'string' && !route.component.startsWith('@/') && !route.component.startsWith('/')) {
