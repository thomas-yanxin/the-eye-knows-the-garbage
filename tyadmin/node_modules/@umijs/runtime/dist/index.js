...
var LoadableContext = React.createContext(null);
...
function createLoadableComponent(loadFn, options) {
  ...
  var LoadableComponent = function LoadableComponent(props, ref) {
    init();
    var context = React__default.useContext(LoadableContext);
    var state = useSubscription.useSubscription(subscription);
  ...
  var LoadableComponentWithRef = React__default.forwardRef(LoadableComponent); // add static method in React.forwardRef
...
Object.defineProperty(exports, 'MemoryRouter', {
  enumerable: true,
  get: function () {
    return reactRouterDom.MemoryRouter;
  }
});
...
Object.defineProperty(exports, 'StaticRouter', {
  enumerable: true,
  get: function () {
    return reactRouterDom.StaticRouter;
  }
});
