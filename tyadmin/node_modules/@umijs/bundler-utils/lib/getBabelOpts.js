...
function getBasicBabelLoaderOpts({
  ...
  const prefix = (0, _fs().existsSync)((0, _path().join)(cwd, 'src')) ? 'src/' : '';
  return {
    // Tell babel to guess the type, instead assuming all files are modules
    // https://github.com/webpack/webpack/issues/4039#issuecomment-419284940
    sourceType: 'unambiguous',
    babelrc: false,
    cacheDirectory: process.env.BABEL_CACHE !== 'none' ? `${prefix}.umi/.cache/babel-loader` : false
  };
}
...
function getBabelOpts({
  ...
  return _objectSpread({}, getBasicBabelLoaderOpts({
    cwd
  }), {
