...
describe('yorkie', () => {
  ...
  it('should support basic layout', () => {
    ...
    expect(hook).toMatch(`node "./node_modules/@umijs/yorkie/src/runner.js" pre-commit`);
  ...
  it('should migrate existing scripts (ghooks)', () => {
    ...
    writeFile(dir, 'package.json', '{}');
    mkdir(dir, '/node_modules/yorkie');
    writeFile(dir, '.git/hooks/pre-commit', '// Generated by ghooks. Do not edit this file.');
