  ...
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    api.writeTmpFile({
      ...
      content: Mustache.render(historyTpl, {
        ...
        options: JSON.stringify(_objectSpread({}, options, {}, type === 'browser' || type === 'hash' ? {
          basename: api.config.base
        } : {}), null, 2),
        runtimePath: (0, _utils().winPath)((0, _path().dirname)(require.resolve('@umijs/runtime/package.json')))
      })
    });
  }));
  api.addUmiExports(() => {
