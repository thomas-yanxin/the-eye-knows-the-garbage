...
function DatetimePanel(props) {
  ...
  var timeProps = (0, _typeof2.default)(showTime) === 'object' ? _objectSpread({}, showTime) : {}; // ======================= Keyboard =======================
  ...
  return React.createElement("div", {
    ...
    onSelect: function onSelect(date) {
      onInternalSelect(setTime(generateConfig, date, showTime && (0, _typeof2.default)(showTime) === 'object' ? showTime.defaultValue : null), 'date');
    }
