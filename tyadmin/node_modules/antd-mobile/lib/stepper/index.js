...
var Stepper = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Stepper, [{
        ...
        value: function render() {
            ...
            return React.createElement(_rmcInputNumber2['default'], (0, _extends3['default'])({ upHandler: React.createElement(_icon2['default'], { type: 'plus', size: 'xxs' }), downHandler: React.createElement(_icon2['default'], { type: 'minus', size: 'xxs' }) }, restProps, { ref: function ref(el) {
