    ...
    function Dialog(props) {
        ...
        _this.getMaskElement = function () {
            ...
            if (props.mask) {
                ...
                maskElement = React.createElement(_LazyRenderBox2['default'], _extends({ style: _this.getMaskStyle(), key: "mask", className: props.prefixCls + '-mask', hiddenClassName: props.prefixCls + '-mask-hidden', visible: props.visible }, props.maskProps));
                if (maskTransition) {
