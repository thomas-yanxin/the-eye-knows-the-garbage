...
from tyadmin_api_cli.adapters.django_celery_beat_ty_admin import \
    PeriodicTask_task

from tyadmin_api.views import (  # TyAdminEmailVerifyRecordViewSet,; TyAdminSysLogViewSet,
    CaptchaView, CurrentUserView, DashBoardView, LoginView, MenuView,
    UploadView, UserChangePasswordView, UserListChangePasswordView,
    UserLogoutView, UserSendCaptchaView)
